...
private _rocket ="CMflare_Chaff_Ammo" createVehicleLocal [_firing_position select 0,_firing_position select 1, 0];
_rocket setVelocity _initial_velocity;


private _lightPrimary = "#lightpoint" createVehicleLocal [0,0,0];
...
private _lightSecondary = "#lightpoint" createVehicleLocal [0,0,0];
